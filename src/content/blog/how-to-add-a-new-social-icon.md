...
The maintainer of the theme [nvkhuy](https://github.com/satnaing) has said that he intends to only
...
Full code for the above steps can be found in [this pull request](https://github.com/nvkhuy/nvkhuy.github.io/pull/216/files)
